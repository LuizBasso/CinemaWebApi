...
namespace Cinema.WebApi.Controllers
{
    ...
    public class SessaoController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Atualizar(string id, [FromBody] NovaSessaoInputModel sessaoInputModel, CancellationToken cancellationToken)
        {
            ...
            sessao.Preco = sessaoInputModel.ValorIngresso;
